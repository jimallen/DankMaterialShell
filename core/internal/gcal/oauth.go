...
// getConfigDir returns ~/.config/DankMaterialShell
func getConfigDir() (string, error) {
	...
	return filepath.Join(configHome, "DankMaterialShell"), nil
}

// getDataDir returns ~/.local/share/DankMaterialShell
func getDataDir() (string, error) {
	...
	dir := filepath.Join(dataHome, "DankMaterialShell")
...
func RunAuthFlow(creds *Credentials) error {
...
func GetClient(ctx context.Context) (*http.Client, error) {
	...
	if token == nil {
		return nil, fmt.Errorf("%s: no token found - run 'dms gcal auth' first", ErrNotConfigured)
	}
